...
var telrService = {
	...
	start : function(){
		debugger
		var amountValue = 99;
		var mobileRequest1 = new RootRequest(new MobileRequest("23697", "WWVN^wMLzm@7QRd6", 
			new Device("36C0EC49-AA2F-47DC-A4D7-D9927A739F5F","Android")	, 
			new App("14294","TelrSDK","14294","0.0.1"), 
			new Tran("1", "auth", "paypage", Math.random()*100000000000000000, "Test Mobile API", "AED", amountValue), 
			new Billing(new Name("john","Sakr","Mrs"), new Address("SIT", "Dubai", "UAE", "Dubai"), "mnrathore7@gmail.com")));
